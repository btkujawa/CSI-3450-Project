...
<head>
    ...
    <script src="/js/createStandardUser.js"></script>
                ...
                <div class="d-flex align-items-center flex-column flex-grow-1 text-white-50 rounded box-shadow">
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" id="user_password" placeholder="Password" required yle="background-color: #E6F2F8;">
                        </div>
                        <button class="btn btn-primary" role="button" id="createUserButton" onclick="createStandardUser() " style="background-color: #2DE2E6; color: #261447">Sign up</button>
                </div>
